...
<div class="">
    <div class="header">
        <span class="title"><img src="cards/logo-header.png" height="50px" />&nbsp;&nbsp;irlpoker.net</span>
    </div>
    ...
    <div class="form form-start" style="display: none;">
        <form action="#" method="POST" class="m-auto" style="max-width:600px">
            ...
            <div class="form-group mb-3 row"><label for="gamepin" class="col-md-5 col-form-label">gamepin</label>
                <div class="col-md-7"><input type="text" class="form-control form-control-lg" id="gamecode2" name="gamepin" required><small class="form-text"> create 6 digits pin</small></div>
            </div>
            <div class="form-group mb-3 row"><label for="-players4" class="col-md-5 col-form-label"># players</label>
                <div class="col-md-7"><input type="text" class="form-control form-control-lg" id="-players4" name="players" required><small class="form-text"> max 9</small></div>
            </div>
            <hr class="my-4" />
    ...
    <div class="form form-join" style="display: none;">
        <form class="m-auto" action="#" method="POST" style="max-width:600px">
            ...
            <div class="form-group mb-3 row"><label for="gamecode3" class="col-md-5 col-form-label">gamecode</label>
                <div class="col-md-7"><input type="text" class="form-control form-control-lg" id="gamecode3" name="gamecode" required><small class="form-text"> 6 digits code</small></div>
            </div>
            <div class="form-group mb-3 row"><label for="personal-passcode5" class="col-md-5 col-form-label">gamepin</label>
                <div class="col-md-7"><input type="text" class="form-control form-control-lg" id="personal-passcode5" name="gamepin2" required><small class="form-text"> 6 digits pin</small></div>
            </div>
            <hr class="my-4" />
